...
public class Game {
	...
	private Player[] players = new Player[Constants.SIMBOL_PLAYERS.length];
	...
	public void play() throws IOException {
		...
		while (!gameEnded) {
			...
			try {
				sequenceFound = currentPlayer.paly();
			
			} catch (InvalidMoveException e) {
				UI.printText("ERR: " + e.getMessage());
				continue;
			}
	...
	private Player createPlayer(int index) {
		...
		char symbol = Constants.SIMBOL_PLAYERS[index];
